...
const preferences = {
  ...
  updateNotification: {
    ...
    description: 'Notify about Today\'s Dental Desktop updates available on launch',
    default: true,
    frontend: {
      element: 'toggle',
  ...
  usageStatistics: {
    ...
    description: 'Share usage statistics with Today\'s Dental Developers. Statistics include only versions of Today\'s Dental Desktop, Operating System, and backend installation ID. We don\'t collect any personal data, and all collected statistics will be used only to better understand how we can improve the desktop application experience.',
    default: true,
    frontend: {
      element: 'toggle',
  ...
  errorReporting: {
    ...
    description: 'When an error occurs, Today\'s Dental Desktop will send an anonymized report to the development team with details concerning that error. Application restart is required to apply the new sharing policy.',
    default: true,
    frontend: {
      element: 'toggle',
