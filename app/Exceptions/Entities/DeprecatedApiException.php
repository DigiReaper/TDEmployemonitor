...
class DeprecatedApiException extends HttpException
{
    public function __construct()
    {
        ...
        \Log::warning("Deprecated method {$deprecatedMethod} called, update Today\'s Dental client", [
        ...
        parent::__construct("Deprecated method {$deprecatedMethod} called, update Today\'s Dental client");
    }
}
