 ...
 * @type {String}
 */
const packageId = isDeveloperModeEnabled ? 'todaysdental-develop' : 'todaysdental';
...
configuration.sentry = {
  ...
  release: `todaysdental@${packageVersion}`,
...
configuration.usageStatistics = {
   ...
   */
  collectorUrl: 'https://stats.todaysdental.app',
...
configuration.updateNotification = {
   ...
   * @type {String}
   */
  downloadsPageUrl: 'https://todaysdental.app/desktop',
